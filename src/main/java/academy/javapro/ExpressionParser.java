...
class ExpressionParser {
    ...
    private double parseFactor() {
        // TODO: Check if we have an opening parenthesis and haven't reached end of
        // input
    ...
    private double parseNumber() {
        ...
        // TODO: While we haven't reached the end and current char is digit or decimal
        // point
        ...
        while (position < input.length() && Character.isDigit(input.charAt(position))
            ...
            sd.append(input.charAt(position));
            position++;
        }
        return Double.parseDouble(sd.toString());
